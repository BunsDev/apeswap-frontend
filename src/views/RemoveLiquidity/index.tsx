...
import { ETHER, JSBI, Percent, Token, ROUTER_ADDRESS } from 'soulswap-sdk'
import { LargeStyledButton } from 'views/Swap/styles'
import track from 'utils/track'
import Page from 'components/layout/Page'
import { Text, AddIcon, Flex, Card, useModal, useMatchBreakpoints, Button, AutoRenewIcon } from 'soulswap-uikit'
